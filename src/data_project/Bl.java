...
public class Bl extends JButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = shadowSize; i >= 1; i--) { // Draw layers of shadow, decreasing in size
            ...
            g2d.drawOval(-i + insets.left, -i + insets.top, getWidth() + 2 * i, getHeight() + 2 * i); // Draw larger circles for each layer
        }
